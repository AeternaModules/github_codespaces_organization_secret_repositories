output "codespaces_organization_secret_repositorieses_id" {
  ...
  value       = { for k, v in github_codespaces_organization_secret_repositories.codespaces_organization_secret_repositorieses : k => v.id if v.id != null && length(v.id) > 0 }
}
output "codespaces_organization_secret_repositorieses_secret_name" {
  ...
  value       = { for k, v in github_codespaces_organization_secret_repositories.codespaces_organization_secret_repositorieses : k => v.secret_name if v.secret_name != null && length(v.secret_name) > 0 }
}
output "codespaces_organization_secret_repositorieses_selected_repository_ids" {
  ...
  value       = { for k, v in github_codespaces_organization_secret_repositories.codespaces_organization_secret_repositorieses : k => v.selected_repository_ids if v.selected_repository_ids != null && length(v.selected_repository_ids) > 0 }
}
